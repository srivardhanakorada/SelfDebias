...
save_path = "centroids/centroids_device.pt"
vis_dir = "centroids/umap_plots_device"
device = "cuda:1"
num_timesteps = 51
k = 2
...
to_remove =  [205, 329, 424, 508, 607, 749, 1074, 1440, 1466, 1471, 1621, 1636, 1754] 
all_files = [file for i,file in enumerate(all_files) if i not in to_remove]
