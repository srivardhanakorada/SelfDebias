    ...
    def __call__(
        ...
        **kwargs,
        ...
        for i, t in enumerate(timesteps):
            ...
            h_vecs.append(h)
            if grad_list is not None: grad_list.append(grads)
        ...
        if ret_h : return StableDiffusionPipelineOutput(images=image, nsfw_content_detected=has_nsfw_concept),h_vecs
        else: return StableDiffusionPipelineOutput(images=image, nsfw_content_detected=has_nsfw_concept),grad_list
